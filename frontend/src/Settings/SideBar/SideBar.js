import React, { useState } from 'react';
 ...
 const SideBar = ({showSide,setshowSide,selectedPage, setSelectedPage}) => {
   ...
   return (
       <aside  class={showSide === true ?  "absolute fixed top-0 left-0 z-40 w-64 h-screen transition-transform translate-x-0" : "fixed top-[63px] left-0 z-40 w-64 h-screen transition-transform -translate-x-full sm:translate-x-0"}>
       
         <div class="h-full px-3 py-1 bg-gray-50 dark:bg-gray-600">
          {/* <div>
            <button onClick={()=> setshowSide(!showSide)} type="button" class="inline-flex items-center p-2 mt-2 ml-3 text-sm text-gray-500 rounded-lg sm:hidden hover:bg-gray-100 focus:outline-none focus:ring-2 focus:ring-gray-200 dark:text-gray-400 dark:hover:bg-gray-700 dark:focus:ring-gray-600">
           ...
           <li onClick={() => setSelectedPage("password")}>
               <a href="#" class="flex items-center p-2 text-gray-900 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700">
                 ...
                 <span class="flex-1 ml-3 whitespace-nowrap">password & security</span>
           ...
           <li onClick={() => setSelectedPage("savedPost")}>
               <a href="#" class="flex items-center p-2 text-gray-900 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700">
                 ...
                 <span class="flex-1 ml-3 whitespace-nowrap">Saved posts</span>
               </a>
             </li>
             <li>
               <a href="#" class="flex items-center p-2 text-gray-900 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700">
           ...
           <ul class="pt-4 mt-4 space-y-2 font-medium border-t border-gray-200 dark:border-gray-700">
             ...
             <li>
               <a href="#" class="flex items-center p-2 text-gray-900 transition duration-75 rounded-lg hover:bg-gray-100 dark:hover:bg-gray-700 dark:text-white group">
                 ...
                 <span class="ml-3">report and block</span>
               </a>
             </li>
             <li>
               <a href="#" class="flex items-center p-2 text-gray-900 transition duration-75 rounded-lg hover:bg-gray-100 dark:hover:bg-gray-700 dark:text-white group">
