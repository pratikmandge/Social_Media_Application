...
const Alert = ({errorMessage,errorCode, errorColor,setAlert}) => {
    return (
        <div>
            <div class={`bg-${errorColor}-100 border border-${errorColor}-400 text-${errorColor}-700 px-4 py-3 rounded relative`} role="alert">
                <strong class="font-bold">{errorCode}!</strong>
